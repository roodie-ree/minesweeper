...
public class MineSweeperPlayGround {
	...
	public MineSweeperPlayGround() {
		...
		width = 4;
		bombs = 3;
		tiles = Arrays.asList(new MineSweeperTile(), new MineSweeperTile(), new MineSweeperTile(),
				new MineSweeperTile().addBomb(), new MineSweeperTile(), new MineSweeperTile().addBomb(),
				new MineSweeperTile(), new MineSweeperTile(), new MineSweeperTile(), new MineSweeperTile(),
				new MineSweeperTile(), new MineSweeperTile().addBomb(), new MineSweeperTile(), new MineSweeperTile(),
	...
	private Long countOpenTiles() {
		return tiles.stream().filter(tile -> !tile.isHidden()).count();
	}
